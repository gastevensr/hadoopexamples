 ...
 * 
 */
package com.gasr.hadoopbook.hadoopbook.chapter06.v2;
...
import com.gasr.hadoopbook.chapter06.v2.MaxTemperatureDriver;
...
public class MaxTemperatureDriverTest {
	...
	private void checkOutput(Configuration conf, Path output) throws IOException {
		...
		BufferedReader expected = asBufferedReader(getClass().getResourceAsStream("/expeced.txt"));
		String expectedLine;
